                                                                                                                                                                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                                                                                                                                                                    const r = await fetch('/health');
                                                                                                                                                                                                                                                                                                                                                                                                                                                    out.textContent = JSON.stringify(await r.json(), null, 2);
                                                                                                                                                                                                                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                            async function testPersistence() {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            const r = await fetch('/test/persistence', { method: 'POST', headers: {'Content-Type': 'application/json'}, body: JSON.stringify({key: document.getElementById('pKey').value, value: document.getElementById('pValue').value}) });
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            out.textContent = JSON.stringify(await r.json(), null, 2);
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        }
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    async function testNovelty() {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    const r = await fetch('/test/novelty', { method: 'POST', headers: {'Content-Type': 'application/json'}, body: JSON.stringify({value: document.getElementById('nValue').value}) });
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    out.textContent = JSON.stringify(await r.json(), null, 2);
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                }
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            async function testNull() {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            const r = await fetch('/test/null', { method: 'POST', headers: {'Content-Type': 'application/json'}, body: JSON.stringify({key: document.getElementById('nullKey').value}) });
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            out.textContent = JSON.stringify(await r.json(), null, 2);
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        }
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                </script>
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    </body>
